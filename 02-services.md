...
**Headline:** Every car gets the same care. The work scales to what the car needs.

**Body:** Some projects are full bare-metal restorations that take most of a year. Some are subtle corrections to a finish that's almost there. We approach both with the same standards — the only thing that changes is the scope.

---

## Service 1 — Full Restoration Paint
...
## Service 2 — Color Matching & Factory Restoration
...
**Why it matters:** Factory paint codes are starting points, not formulas. Pigments fade, manufacturers change suppliers, and a 1967 code mixed today rarely matches the car it left the factory on. We blend to the car you have, not the chip in the book.

---

## Service 3 — Custom & Commissioned Color
...
**Process:** We start with a conversation, not a swatch. Where will the car live? What's the interior color? What does the car need to do — turn heads at a show, look right at a coffee meet, or photograph beautifully? The color is a decision the car has to live with.

---

## Service 4 — Spot Repair & Panel-Matching

**Best for:** Existing high-quality finishes that have been damaged in one area.

**What's included:**
- Color-match to existing finish using spectrophotometer + visual review
- Blend repair — feathering color into adjacent panels for invisibility
- Clear blend and polish to match surrounding gloss

**Honest note:** Not every paint job can be spot-repaired invisibly. If the existing finish is too oxidized, off-color, or aged, we'll tell you that and recommend the right approach instead.

---

## Service 5 — Engine Bay & Chassis Refinishing
...
- Engine bay color, often body-color or factory-correct semi-gloss black
- Suspension component refinishing
- Inner fender, firewall, trunk pan refinishing

---

## Service 6 — Pre-Auction & Show Prep

**Best for:** Cars heading to Mecum, Barrett-Jackson, RM, Pebble, Amelia, or similar venues.
...
**What's included:**
- Shop visit (or video consult) to review the project
